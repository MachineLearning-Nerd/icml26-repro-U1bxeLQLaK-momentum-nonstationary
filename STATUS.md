...
- State: `locally_complete_pending_publication`
...
Push the public GitHub repository, then atomically enqueue the complete paper
through the canonical HF backlog. The single shared publisher owns Hub release.
